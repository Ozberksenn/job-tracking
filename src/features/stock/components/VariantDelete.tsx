...
import { useDeleteProductVariant } from "@/lib/api/stock/mutations"
import { ProductVariantType } from "@/lib/api/stock/types"
import { Trash } from "lucide-react"


export const VariantDelete = ({ param }: { param: ProductVariantType }) => {
    const deleteProduct = useDeleteProductVariant()
